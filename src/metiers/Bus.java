...
public class Bus extends Vehicule {
    ...
    public Bus(int numVehicule, String marque, String modele, LocalDate dateFabrication, LocalDate dateMiseEnService, LocalDateTime dateHeureDerniereMaintenance) {
