...
public class ConduitSur {
    ...
    public String toString() {
        return "Ligne = " + uneLigne.getLibelle() + " Chauffeur = " + leChauffeur.getUtilisateur().getUsername() + " Véhicule : " + unVehicule.getNumVehicule() + " dateHeureConduite : " + dateHeureConduite;
    }
}
