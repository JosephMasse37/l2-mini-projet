...
public class Tram extends Vehicule {
    ...
    public Tram(int numVehicule, String marque, String modele, LocalDate dateFabrication, LocalDate dateMiseEnService, LocalDateTime dateHeureDerniereMaintenance) {
        super(numVehicule, marque, modele, dateFabrication, dateMiseEnService, dateHeureDerniereMaintenance);
    }
